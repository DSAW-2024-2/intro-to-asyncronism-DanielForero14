document.addEventListener("DOMContentLoaded", () => {
  ...
  // Nuevo: Manejar la entrada del formulario de búsqueda por ID
  document
  ...
  // Nuevo: Función para buscar Pokémon por ID
  ...
  // Función para mostrar los detalles del Pokémon incluyendo el ID
